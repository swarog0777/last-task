!function (t, e) {
    ...
    return function (t) {
        ...
        var o = n(9), i = r(o), a = n(10), u = r(a), c = n(11), s = r(c), f = n(7), l = r(f), p = n(4), h = r(p),
            d = n(12), y = r(d), m = n(13), v = r(m), b = n(5), g = r(b), x = n(14), w = r(x);
        ...
        var u = Object.assign || function (t) {
            ...
            return t
        }, c = n(3), s = (r(c), n(8)), f = r(s), l = n(2), p = r(l), h = n(1), d = r(h), y = function (t) {
            function e() {
                var n, r, a;
                o(this, e);
        ...
        y.contextTypes = {router: d.default.object}, y.childContextTypes = {router: d.default.object.isRequired}, e.default = y
    }, function (t, e, n) {
        "use strict";
        ...
        e.__esModule = !0;
        var o = n(21), i = r(o), a = {}, u = 1e4, c = 0, s = function (t, e) {
            var n = "" + e.end + e.strict, r = a[n] || (a[n] = {});
            if (r[t]) return r[t];
            var o = [], s = (0, i.default)(t, o, e), f = {re: s, keys: o};
            return c < u && (r[t] = f, c++), f
        }, f = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            "string" == typeof e && (e = {path: e});
            var n = e, r = n.path, o = void 0 === r ? "/" : r, i = n.exact, a = void 0 !== i && i, u = n.strict,
                c = void 0 !== u && u, f = s(o, {end: a, strict: c}), l = f.re, p = f.keys, h = l.exec(t);
            if (!h) return null;
            var d = h[0], y = h.slice(1), m = t === d;
            return a && !m ? null : {
                path: o,
                url: "/" === o && "" === d ? "/" : d,
                isExact: m,
        ...
        var u = Object.assign || function (t) {
            ...
            return t
        }, c = n(3), s = (r(c), n(2)), f = r(s), l = n(1), p = r(l), h = n(5), d = r(h), y = function (t) {
            function e() {
                var n, r, a;
                o(this, e);
                for (var u = arguments.length, c = Array(u), s = 0; s < u; s++) c[s] = arguments[s];
            ...
            return a(e, t), e.prototype.getChildContext = function () {
                ...
                return o ? (0, d.default)(c, {path: o, strict: i, exact: a}) : u.match
            }, e.prototype.componentWillMount = function () {
                var t = this.props;
                ...
                var e = this.state.match, n = this.props, r = n.children, o = n.component, t = n.render,
        ...
        }, y.childContextTypes = {router: p.default.object.isRequired}, e.default = y
    }, function (t, e, n) {
        "use strict";
        ...
        e.__esModule = !0;
        var u = n(2), c = r(u), s = n(1), f = (r(s), n(18)), l = r(f), p = n(4), h = r(p), d = function (t) {
            function e() {
                var n, r, a;
                o(this, e);
                for (var u = arguments.length, c = Array(u), s = 0; s < u; s++) c[s] = arguments[s];
        ...
        e.__esModule = !0;
        var u = n(2), c = r(u), s = n(1), f = r(s), l = function (t) {
            function e() {
        ...
        l.defaultProps = {when: !0}, l.contextTypes = {router: f.default.shape({history: f.default.shape({block: f.default.func.isRequired}).isRequired}).isRequired}, e.default = l
    }, function (t, e, n) {
        "use strict";
        ...
        l.defaultProps = {push: !1}, l.contextTypes = {
            router: f.default.shape({
                ...
                }).isRequired, staticContext: f.default.object
            }).isRequired
        }, e.default = l
    }, function (t, e, n) {
        "use strict";
        ...
        var c = Object.assign || function (t) {
            ...
            return t
        }, s = n(8), f = r(s), l = n(2), p = r(l), h = n(1), d = r(h), y = n(6), m = n(4), v = r(m), b = function (t) {
            ...
            return 0 !== e.pathname.indexOf(n) ? e : c({}, e, {pathname: e.pathname.substr(n.length)})
        }, w = function (t) {
            ...
            return u(e, t), e.prototype.getChildContext = function () {
                ...
                var t = this.props, e = t.basename, n = (t.context, t.location),
                    r = o(t, ["basename", "context", "location"]), i = {
                ...
                return p.default.createElement(v.default, c({}, r, {history: i}))
            }, e
        }(p.default.Component);
        R.defaultProps = {
            basename: "",
            location: "/"
        }, R.childContextTypes = {router: d.default.object.isRequired}, e.default = R
    }, function (t, e, n) {
        "use strict";
        ...
        e.__esModule = !0;
        var u = n(2), c = r(u), s = n(1), f = r(s), l = n(3), p = (r(l), n(5)), h = r(p), d = function (t) {
            function e() {
                return o(this, e), i(this, t.apply(this, arguments))
            }
            ...
            return a(e, t), e.prototype.componentWillReceiveProps = function (t) {
                ...
                return c.default.Children.forEach(e, function (e) {
                    if (c.default.isValidElement(e)) {
                        var i = e.props, a = i.path, u = i.exact, s = i.strict, f = i.from, l = a || f;
        ...
        d.contextTypes = {router: f.default.shape({route: f.default.object.isRequired}).isRequired}, e.default = d
    }, function (t, e, n) {
        "use strict";
        ...
        var i = Object.assign || function (t) {
            ...
            return t
        }, a = n(2), u = r(a), c = n(1), s = (r(c), n(20)), f = r(s), l = n(7), p = r(l), h = function (t) {
            var e = function (e) {
        ...
        var o = Object.assign || function (t) {
            ...
            return t
        }, i = n(24), a = r(i), u = n(25), c = r(u), s = n(6);
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = t.getUserConfirmation,
                ...
                h = t.keyLength, d = void 0 === h ? 6 : h, y = (0, l.default)(), m = function (t) {
                    ...
                    var r = "PUSH", i = (0, s.createLocation)(t, n, v(), M.location);
                    ...
                    var r = "REPLACE", i = (0, s.createLocation)(t, n, v(), M.location);
                    y.confirmTransitionTo(i, r, e, function (t) {
                        t && (M.entries[M.index] = i, m({action: r, location: i}))
                    })
                }, _ = function (t) {
                    var n = p(M.index + t, 0, M.entries.length - 1), r = "POP", o = M.entries[n];
        ...
        e.__esModule = !0;
        var o = n(3), i = r(o), a = function () {
            var t = null, e = function (e) {
                return (0, i.default)(null == t, "A history supports only one prompt at a time"), t = e, function () {
                    t === e && (t = null)
                }
            }, n = function (e, n, r, o) {
                if (null != t) {
        ...
        function r(t, e) {
            for (var n, r = [], o = 0, i = 0, a = "", u = e && e.delimiter || "/"; null != (n = b.exec(t));) {
                var f = n[0], l = n[1], p = n.index;
                if (a += t.slice(i, p), i = p + f.length, l) a += l[1]; else {
                    var h = t[i], d = n[2], y = n[3], m = n[4], v = n[5], g = n[6], x = n[7];
                    a && (r.push(a), a = "");
                    var w = null != d && null != h && h !== d, O = "+" === g || "*" === g, _ = "?" === g || "*" === g,
                        j = n[2] || u, R = m || v;
                    r.push({
                        name: y || o++,
                        prefix: d || "",
        ...
        var n = function (t) {
            ...
            var e = arguments.length <= 1 || void 0 === arguments[1] ? "" : arguments[1], o = t && t.split("/") || [],
                i = e && e.split("/") || [], a = t && n(t), u = e && n(e), c = a || u;
        ...
        var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            var o = "undefined" == typeof e ? "undefined" : n(e), i = "undefined" == typeof r ? "undefined" : n(r);
            if (o !== i) return !1;
            if ("object" === o) {
